...
> **金融方向推演预测**现已支持：将市场场景作为模拟需求描述后，ReportAgent 可调用 `market_data` 工具获取真实的股票/加密货币价格与技术指标（SMA20/SMA50/RSI14，无需配置 API Key），与模拟出的舆论情绪信号结合，形成更可信的预测报告。**时政要闻推演预测**等示例陆续更新中...
